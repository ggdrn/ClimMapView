...
$query = "SELECT dataMedicao, idEstacao, total FROM `dadosbrutos` WHERE (`dataMedicao` between ? and ?) and idEstacao = ?";
...
if ($stmt = $db->prepare($query)){
	...
	foreach(glob('./relatorioBruto/*.csv') as $file)
	{
	...
	$arquivo= "./relatorioBruto/dadosbrutos_".$_GET["id"]."_".$inicio."_".$fim.".csv";
